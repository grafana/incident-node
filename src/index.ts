...
export function ActivityQuerySchema() {
  return z.object({
    ...
    activityKind: z.string().array().optional(),
  });
}
...
export function IncidentsQuerySchema() {
  return z.object({
    limit: z.number(),
    includeStatuses: z.enum(["active", "resolved", ""]).array().optional(),
    excludeStatuses: z.enum(["active", "resolved", ""]).array().optional(),
    incidentLabels: z.string().array().optional(),
